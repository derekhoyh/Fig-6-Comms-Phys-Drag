...
nrms2=5;  %nrms of passive layer in units of 10^10 cm^-2
eta=0; %correlation coefficient in the bivariate normal distribution
ng1=(40:0.1:60); %avrg density of active layer in units of 10^10 cm^-2.
ng2=-50; %avrg density of passive layer in units of 10^10 cm^-2.

% Define the monolayer and drag conductivity functions
monocondA=@(n1) 0.01*T^2+7.1*abs(n1); %conductivity in units of e^2/h, where n is in units of 10^10cm^-2.
% Numbers taken from nimp=5e10 cm^-2 numerical calculation of sigma. 

monocondP=@(n2) 0.01*T^2+7.1*abs(n2);
...
save(['rhodemtvsng1-nrms1-' num2str(nrms1) '-nrms2-' num2str(nrms2) '.mat'])
